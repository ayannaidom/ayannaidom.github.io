...
$(document).ready(function(){
    ...
    //dyanmically create category list from JSON file
    $.ajax({
        type: "get",
        url: "https://parkland-csc175.github.io/csc175data/bestbuy/categories-list.json", //use sample data to pull info
        //TEST url: "https://parkland-csc175.github.io/csc175data/bestbuy/categories-list.jsonXYZ",
        beforeSend: function() {$("#category").html("LOADING...");},
        timeout: 10000,
        ...
        success: function(data) {
            ...
            $.each(data.categories, function(i, item) {
                ...
                //when user clicks link, they are redirected to subcategories-list.html
                $aTag.attr({'href': "subcategories-list.html", 'data-target': i, 'id': item.id}); 
